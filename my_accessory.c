...
homekit_characteristic_t cha_name = HOMEKIT_CHARACTERISTIC_(NAME, "Povodu RGB Controller");
...
homekit_accessory_t *accessories[] = {
    HOMEKIT_ACCESSORY(.id=1, .category=homekit_accessory_category_lightbulb, .services=(homekit_service_t*[]) {
        HOMEKIT_SERVICE(ACCESSORY_INFORMATION, .characteristics=(homekit_characteristic_t*[]) {
            HOMEKIT_CHARACTERISTIC(NAME, "Povodu RGB - deneme"),
            HOMEKIT_CHARACTERISTIC(MANUFACTURER, "Povodu"),
            HOMEKIT_CHARACTERISTIC(SERIAL_NUMBER, "28062004"),
            HOMEKIT_CHARACTERISTIC(MODEL, "Povodu RGB Controller V1.0"),
